          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
                 ...
                 <div>
                  ...
                  <p className="text-gray-600">contacto@jsfly.com</p>
                </div>
              </div>
            ...
            {/* Social Media */}
               ...
               <div className="flex space-x-4">
                 <a href="#" className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors duration-200">
